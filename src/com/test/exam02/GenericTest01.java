...
class GStack<T> {
    ...
    public void push(T item) {
         ...
         *   2. tos = 1 , 1번째에 "Busan", tos = 2,
         *   3. tos = 2 , 2번째에 "LA" ,   tos = 3
         * 
         * 
         */
    }
    ...
    public T pop()  
     ...
     // 자료구조에서 LIFO 방식으로 데이터를 관리하는 메모리 공간을 Stack
     // 반대로 가장 먼저 넣은 값이 가장 먼저 나오는 방식을 First Input First Output (FIFO)
     // 자료구조에서 LIFO 방식으로 데이터를 관리하는 메모리 공간을 Queue
    {
        if(tos == 0) return null; // T가 뭐가 들어올지 아직 정해지지 않았지만 그래도 뭔가 리턴해줘야 할 때 null을 리턴
        tos--;
        return (T)stck[tos]; 
